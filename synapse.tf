...
resource "azurerm_private_endpoint" "synapse_private_link_hub_endpoint" {
  ...
  private_dns_zone_group {
    ...
    private_dns_zone_ids = ["/subscriptions/${data.azurerm_subscription.current.subscription_id}/resourceGroups/core-infra-intsvc-rg/providers/Microsoft.Network/privateDnsZones/privatelink.azuresynapse.net"]
  }
