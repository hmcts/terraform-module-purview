...
| <a name="input_purview_private_dns_zone_id"></a> [purview\_private\_dns\_zone\_id](#input\_purview\_private\_dns\_zone\_id) | Resource ID of an existing **privatelink.purview.azure.com** zone (e.g. central azure-private-dns). When set, the module does not create that zone or a spoke VNet link. | `string` | `null` | no |
